...
string slicer()
{
    string result = "slic3r-console.exe ";
    return result;

}

string cmdOutTo(string path)
{
    string result = "> " + path + " ";
    return result;
...
string sliceGcode(string modelPath, string outputDir = "NULL")
{
    string result;
    if (outputDir == "NULL")
    {
        result = "--gcode-comments " + modelPath + " ";
    }
    else
    {
...
Printer options :
    ...
    --thin - walls        Detect single - width walls(default: yes)
                                                        --detect - bridging - perimeters  Detect bridging perimeters and apply bridge flow, speedand fan
                        (default: yes)
    ...
    --wipe              Wipe the nozzle while doing a retraction(default: no)
        ...
        Retraction options for multi - extruder setups :
                        ...
                        switching tool(default: 0)
                                                                                       ...
                                                                                       Cooling options :
                                                                                   --cooling           Enable fanand cooling control
    ...
    --duplicate - distance Distance in mm between copies(default: 6)
        ...
        Sequential printing options :
                        ...
                        extruder tipand carriage bottom(default: 20)
    ...
    --bridge - flow - ratio Multiplier for extrusion when bridging(> 0, default: 1)
                        ...
                        (can be specified multiple times, default: 0x0)
                                                                   --perimeter - extruder
                        Extruder to use for perimetersand brim(1 + , default: 1)
    --infill - extruder   Extruder to use for infill(1 + , default: 1)
    --solid - infill - extruder   Extruder to use for solid infill(1 + , default: 1)
                                                                   --support - material - extruder
                        Extruder to use for support material, raftand skirt(1 + , default: 1)
